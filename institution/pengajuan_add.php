                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control select2" name="id_rab"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= 'hapus.php?kd=del_real_sm&id=' . $ls_jns['id_realis'] ?>"
...
<?php
            ...
            $sql = mysqli_query($conn, "INSERT INTO real_sm VALUES ('$id', '$lembaga','$bidang','$jenis','$kode', '$qty', '$nominal', '$tgl', '$pj', '$bulan','$tahun_ajaran','$ket', '$kd_pjn', '$nominal', '$nominal', '$stas')");
            if ($sql) { ?>
