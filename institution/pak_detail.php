                ...
                <div class="col-lg-6 col-xs-6">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <button class="btn btn-danger" data-toggle="modal" data-target="#ajukan"><i class="fa fa-mail-forward"></i> Ajukan PAK ke
                                Bendahara</button>
                            <p>Pemakaian</p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($pakaiSm['qty'] > 0 || $sisa == 100) {
                                                            ...
                                                            <a onclick="return confirm('Yakin akan dihapus ?. Menghapus data ini akan menghapus data realisasi juga')" href="<?= 'pak_set.php?kd=del&pak=' . $kode_pak . '&id=' . $r1['id_rab']; ?>"><button class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i>
                                                                    Hapus</button></a>
                                                            <a href="<?= 'pak_edit.php?kd=' . $r1['id_rab'] . '&pak=' . $kode_pak; ?>"><button class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i>
                                                                    Edit</button></a>
                        ...
                        <div class="box-body">
                            <div class="callout callout-success">
                                ...
                                <h4>TOTAL : <?= rupiah($dt_rab['tt']); ?>
                                    <?php if ($pakde['status'] === 'belum' || $pakde['status'] === 'ditolak') { ?>
                                        <button class="btn btn-warning pull-right btn-sm" data-toggle="modal" data-target="#tambah_bos"><i class="fa fa-plus"></i> Buat
                                            RAB</button>
                                    <?php } ?>
                                </h4>
                            </div>
                                    ...
                                    <tbody>
                                        <?php while ($r1 = mysqli_fetch_assoc($dt1)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($pakde['status'] === 'belum' || $pakde['status'] === 'ditolak') { ?>
                                                        <a onclick="return confirm('Yakin akan dikembalikan ?')" href="<?= 'pak_set.php?kd=rab&pak=' . $kode_pak . '&id=' . $r1['kode']; ?>"><button class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i></button></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
