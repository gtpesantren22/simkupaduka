    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <button class="btn btn-danger pull-right" data-toggle="modal" data-target="#komodo"><i class="fa fa-trash-o"></i> Kosongkan RAB</button> -->
                        <button class="btn btn-success btn-block"><i class="fa fa-download"></i> Export to
                            Excel</button><br>
                        <b>Pemakaian</b>
...
<!-- Modalksoosong -->
<!-- Modal -->
<div class="modal fade" id="komodo" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <form action="kosong.php" method="post">
                ...
                <div class="modal-body">
                    ...
                    <span style="color: red; font-weight: bold;">Tombol ini akan mengahpus seluruh data RAB serta
                        Realisasi anda. Mohon diperiksa kembali sebelum mengkosonginya. !</span>
