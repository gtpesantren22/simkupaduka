            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="pengajuan.php"><button class="btn btn-warning pull-right btn-xs"><i
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-7">
                                                                <input type="text" name="bulan" id=""
                                                                    class="form-control"
                                                                    value="<?= $bulan[$ck['bulan']] ?>" readonly>
                                                            </div>
                                                            <div class="col-md-5">
                                                                <input type="text" name="tahun" id=""
                                                                    class="form-control" value="<?= $ck['tahun'] ?>"
                                                                    readonly>
                                                            </div>
                                                        </div>
                                                    </th>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-7">
                                                                <input type="text" name="satuan" id=""
                                                                    class="form-control" required
                                                                    placeholder="Satuan (dos/pcs/rim/dll..)">
                                                            </div>
                                                        </div>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>Harga Satuan</th>
                                                    <th><input type="text" name="harga" id="uang" class="form-control"
                                                            required></th>
                                                </tr>
                                                <tr>
                                                    <th>Nama PJ</th>
                                                ...
                                                <tr>
                                                    <th colspan="2"><button class="btn btn-success btn-sm pull-right"
                                                            type="submit" name="save"><i class="fa fa-save"></i>
                                                            Simpan</button></th>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="pengajuan.php"><button class="btn btn-warning pull-right btn-xs"><i
                                    class="fa fa-arrow-left"></i> Kembali</button></a>
                        <?php if ($ck['verval'] == 0 && $ck['apr'] == 0 && $ck['cair'] == 0 && $ck['spj'] == 0 && $ck['stts'] == 'no') { ?>
                        <a href="pj_ok.php?kd=<?= $kode_pengajuan; ?>"
                            onclick="return confirm('Yakin pengajuan sudah selesai dan akan diajukan kepada accouting ?')"><button
                                class="btn btn-info pull-right btn-sm"><i class="fa fa-check"></i> Pengajuan sudah
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <button class="btn btn-success btn-sm" type="submit" name="save_baru"><i
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= 'hapus.php?kd=del_real_sm_disp&id=' . $ls_jns['id_realis'] ?>"
...
if (isset($_POST['save'])) {
    ...
    if ($harga > $kfe) {
        ...
        $sql12 = mysqli_query($conn, "INSERT INTO real_sm VALUES ('$id', '$lembaga','$bidang','$jenis','-', '$qty', '$nominal', '$tgl', '$pj', '$bulan','$tahun_ajaran','$ket', '$kd_pjn', '$nominal', '$nominal', '$stas')");
        if ($sql12) {
            echo "
                <script>
                Swal.fire({
