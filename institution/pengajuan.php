                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table id="example1_bst" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $rls = mysqli_query($conn, "SELECT * FROM pengajuan WHERE lembaga = '$kol' AND kode_pengajuan NOT LIKE '%DISP.%' AND tahun = '$tahun_ajaran' GROUP BY kode_pengajuan ");
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= 'pengajuan_add.php?kode=' . $ls_jns['kode_pengajuan'] ?>"><button
...
if (isset($_POST['save'])) {
    ...
    $kodeBarang = sprintf("%03s", $noUrut) . '.' . $lembaga . '.' . date('dd') . '.' . $bln . '.' . $tahun;
