                    ...
                    <div class="x_content">
                            ...
                            <div class="col-sm-7 invoice-col">
                                <address>
                                    <table class="table">
                                        ...
                                        SUM(total) AS T FROM rab WHERE lembaga = '01' AND tahun = '$tahun_ajaran' "));
                                        ?>
                                        <tr>
                        ...
                        <table id="" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $dt_bos = mysqli_query($conn, "SELECT * FROM rab WHERE lembaga = '01' AND jenis = 'A' AND tahun = '$tahun_ajaran' ");
                                $tt = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total) AS tot FROM rab WHERE lembaga = '01' AND jenis = 'A' AND tahun = '$tahun_ajaran' "));
                        ...
                        <table id="" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $dt_bos = mysqli_query($conn, "SELECT * FROM rab WHERE lembaga = '01' AND jenis = 'B' AND tahun = '$tahun_ajaran' ");
                                $tt = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total) AS tot FROM rab WHERE lembaga = '01' AND jenis = 'B' AND tahun = '$tahun_ajaran' "));
                        ...
                        <table id="" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $dt_bos = mysqli_query($conn, "SELECT * FROM rab WHERE lembaga = '01' AND jenis = 'C' AND tahun = '$tahun_ajaran' ");
                                $tt = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total) AS tot FROM rab WHERE lembaga = '01' AND jenis = 'C' AND tahun = '$tahun_ajaran' "));
                        ...
                        <table id="" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $dt_bos = mysqli_query($conn, "SELECT * FROM rab WHERE lembaga = '01' AND jenis = 'D' AND tahun = '$tahun_ajaran' ");
                                $tt = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(total) AS tot FROM rab WHERE lembaga = '01' AND jenis = 'D' AND tahun = '$tahun_ajaran' "));
