                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <span class="badge badge-success"><i class="fa fa-check"></i> RAB
                                                    Mencukupi</span>
                                                <?php } else { ?>
                                                <span class="badge badge-danger"><i class="fa fa-check"></i> RAB Tidak
                                                    Mencukupi</span>
                                                <?php } ?>
                                            </th>
                                        </tr>
                            ...
                            <div class="col-sm-4 invoice-col">
                                <address>
                                    <strong style="color: darkblue;">Periode :
                                        <?= $bulan[$kl['bulan']] . ' ' . $kl['tahun'] ?></strong><br>
                                ...
                                <address>
                                    ...
                                    <button class="btn btn-success btn-sm" data-toggle="modal"
                                        data-target="#ex_upload"><i class="fa fa-check-square-o"></i>
                                        Verifikasi/Setujui</button><br>
                                    <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#ex_tolak"><i
                                            class="fa fa-times"></i> Tolak pengajuan</button><br>
                                    <?php } ?>
                                </address>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <?php if ($htgd > 0) { ?>
                                            <b><i><a href="../institution/honor_file/<?= $fl['files']; ?>"> (<i
                                                            class="fa fa-download"></i> Download)</a></i></b>
                                            <?php } else { ?>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm('Yakin akan dihapus ?. Menghapus data ini akan menghapus data realisasi juga')"
                                                href="<?= 'hapus.php?kd=real&id=' . $a['id_realis']; ?>"><span
                                                    class="fa fa-trash-o text-danger"> Hapus</span></a>
                                            |
                                            <a type="button" data-toggle="modal"
                                                data-target=".bs-example<?= $a['id_realis'] ?>"><span
                                                    class="fa fa-pencil text-success"> Edit</span></a>

                                            <div class="modal fade bs-example<?= $a['id_realis'] ?>" tabindex="-1"
                                                role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">

                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel2">Edit Nominal
                                                                Pengajuan</h4>
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nom_cair"
                                                                        id="uang<?= $no++ ?>"
                                                                        value="<?= rupiah($a['nom_cair']); ?>"
                                                                        class="form-control" required>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="">Ket. Pencairan</label><br>
                                                                    <input type="radio" name="stas" value="tunai"
                                                                        <?= $a['stas'] === 'tunai' ? 'checked' : ''; ?>
                                                                        required> Cair Tunai
                                                                    <input type="radio" name="stas" value="barang"
                                                                        <?= $a['stas'] === 'barang' ? 'checked' : ''; ?>
                                                                        required> Cair Barang
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">Batal</button>
                                                                <button type="submit" name="ed_nom"
...
<div class="modal fade" id="ex_upload" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" data-parsley-validate class="form-horizontal form-label-left input_mask" action=""
                    method="post">
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama Lembaga <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="" name="lembaga" required="required" value="<?= $l['nama'] ?>"
                                class="form-control" readonly>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tanggal Verifikasi
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Verifikator <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="" name="user" required="required" value="<?= $nama_user ?>"
                                class="form-control" readonly>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name"><span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <button type="submit" name="veris" class="btn btn-success"><i class="fa fa-warning"></i>
                                Verifikasi</button>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="" data-parsley-validate class="form-horizontal form-label-left input_mask" action=""
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tanggal Penolakan
                            <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 ">
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Catatan <span
                                class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <button type="submit" name="tolakPon" class="btn btn-danger"><i class="fa fa-warning"></i>
...
Terimakasih';
    ...
    $sql = mysqli_query($conn, "UPDATE real_sm SET nom_cair = '$nom_cair', nom_serap = '$nom_cair', stas = '$stas', ket = '$ket' WHERE id_realis = '$id_rsm' AND tahun = '$tahun_ajaran' ");
