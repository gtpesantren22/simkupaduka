                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                    data-target="#tambah_bos<?= $a['id_spj'] ?>"><i
                                                        class="fa fa-check"></i> Setujui</button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#tolak_bos<?= $a['id_spj'] ?>"><i
                                                        class="fa fa-times"></i> Tolak</button>
                                                <?php } elseif ($a['stts'] == 2) { ?>
                                                <button class="btn btn-success btn-sm" data-toggle="modal"
                                                    data-target="#uploads<?= $a['id_spj'] ?>"><i
                                                        class="fa fa-money"></i> Upload Sisa</button>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <!-- Modal Setujui BOS-->
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">Form persetujuan SPJ
                                                        </h4>
                                                    ...
                                                    <form id="demo-form2" data-parsley-validate
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="date" id="" required="required"
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="text" required="required" name="user"
                                                                        value="<?= $nama_user ?>" class="form-control"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="modal fade" id="tolak_bos<?= $a['id_spj'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">Form Penolakan SPJ
                                                        </h4>
                                                        <button type="button" class="close" data-dismiss="modal"><span
                                                                aria-hidden="true">×</span>
                                                        </button>
                                                    ...
                                                    <form id="demo-form2" data-parsley-validate
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">Close</button>
                                                            <button type="submit" name="nono" class="btn btn-danger"><i
                                                                    class="fa fa-check"></i> Tolak Now</button>
                                                        </div>
                                                    </form>
