                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl" class="form-control" id="exampleInputEmail1" placeholder="Masukan Tanggal penyetoran" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="penyetor" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama penyetoran" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nominal</label>
                                        <input type="text" name="nominal" class="form-control" id="uang" placeholder="Masukan Jumlah Setoran" required>
                                    </div>
