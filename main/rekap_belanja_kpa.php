    ...
    <div class="">
        ...
        <div class="">
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-bars"></i> Rekapan Belanja berdasarkan KPA <small>Rekapan</small></h2>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-badgeledby="home-tab">
                                ...
                                if (isset($_POST['views'])) {
                                    $lmb = $_POST['lembaga'];
                                    $no = 1;
                                    $dt_bos = mysqli_query($conn, "SELECT a.*, b.nama AS nbd, c.nama AS nlmb, d.nama AS nrab, d.harga_satuan FROM realis a JOIN bidang b ON a.bidang=b.kode JOIN lembaga c ON a.lembaga=c.kode JOIN rab d ON a.kode=d.kode WHERE a.lembaga = '$lmb' AND a.tahun = '$tahun_ajaran' ORDER BY jenis ASC");
                                ?>
