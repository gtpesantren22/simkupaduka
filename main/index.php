        ...
        <div class="top_tiles">
          <div class="animated flipInY col-lg-4 col-md-4 col-sm-6">
            <div class="tile-stats bg-success" style="color: white;">
              ...
              <h3 style="color: white;">Pemasukan - 100%</h3>
              <p style="color: white;"><a href="masuk.php">Lihat rincian data <i class="fa fa-arrow-right"></i></a></p>
            </div>
          </div>
          <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 ">
            <div class="tile-stats bg-danger" style="color: white;">
              <div class="count"><?= rupiah($msk - $sld); ?></div>
              <h3 style="color: white;">Pengeluaran - <?= round(((($msk - $sld) / $msk) * 100), 1); ?>%</h3>
              <p style="color: white;"><a href="#">Lihat rincian data <i class="fa fa-arrow-right"></i></a></p>
            </div>
          </div>
          <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 ">
            <div class="tile-stats bg-primary" style="color: white;">
              <div class="count"><?= rupiah($sld); ?></div>
              <h3 style="color: white;">Saldo - <?= round((($sld / $msk) * 100), 1); ?>%</h3>
              <p style="color: white;"><a href="masuk_saldo.php">Lihat rincian data <i class="fa fa-arrow-right"></i></a></p>
            </div>
          </div>
        </div>
        <!-- <center>
