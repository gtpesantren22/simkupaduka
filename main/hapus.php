...
if ($kd == 'rab') {
    ...
    $cek = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM realis WHERE kode = '$kd' AND tahun = '$tahun_ajaran' "));
    $cek2 = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM real_sm WHERE kode = '$kd' AND tahun = '$tahun_ajaran' "));
