...
$kode_p = $_GET['kode'];
$kl = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM spj WHERE kode_pengajuan = '$kode_p' AND tahun = '$tahun_ajaran' "));
$kode = $kl['lembaga'];
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <iframe src="<?= '../institution/spj_file/' . $kl['file_spj'] ?>" width="100%" height="600"></iframe>
