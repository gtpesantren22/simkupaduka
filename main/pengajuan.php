                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= rupiah($kfe) ?></td>
                                                <td>
                                                    <a href="<?= 'pengajuan_detail.php?kode=' . $a['kode_pengajuan'] ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Cek & Verifikasi</button></a>
                                                    <?php if ($a['cair'] == 0) {  ?>
                                                        <a onclick="return confirm('Menghapus pengajuan juga akan menghapus item-item pengajuannya nya. Yakin akan dihapus ?')" href="<?= 'hapus.php?kd=aju&id=' . $a['kode_pengajuan'] ?>"><button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
