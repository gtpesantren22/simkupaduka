            ...
            <div class="tile-stats">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left input_mask" action="" method="post">
                    <div class="modal-body">
                        <input type="hidden" name="id_pes" value="<?= $a['id_pes']; ?>">
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Kode <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" id="first-name" name="kode" required="required" class="form-control" value="<?= $a['kode']; ?>" disabled>
                            </div>
                        </div>
                        <div class=" item form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="edit_pes" class="btn btn-success">Update data</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function() {
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Pemasukan pesantren berhasil diupdate',
