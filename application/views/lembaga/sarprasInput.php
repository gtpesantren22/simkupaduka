                ...
                <div class="card radius-10">
                    <div class="card-body">
                        ...
                        if ($pj->status == 'belum' | $pj->status == 'ditolak') { ?>
                            <?= form_open('lembaga/sarpAddInput'); ?>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="lembaga" class="form-control" required>
                                                    ...
                                                    <?php foreach ($lembagaData as $lembagaData) : ?>
                                                        <option value="<?= $lembagaData->kode ?>"><?= $lembagaData->nama ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($pj->status == 'belum' | $pj->status == 'ditolak') { ?>
                                                        <a href="<?= base_url('lembaga/delItemSarpras/' . $ls_jns->id_detail) ?>" class="btn btn-danger btn-sm tbl-confirm" value="Yakin akan menghapus item ini"><i class="bx bx-trash"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
