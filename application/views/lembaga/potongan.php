...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Potongan Honor Guru/Karyawan</div>
            <div class="ps-3">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('honor/editPotongan/' . $ls_jns->potongan_id) ?>"><button class="btn btn-info btn-sm"><i class="bx bx-search"></i> Cek Detail </button></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
