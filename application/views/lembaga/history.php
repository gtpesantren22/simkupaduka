                            ...
                            <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Lembaga</th>
                                        <th>Periode</th>
                                        <th>Perencanaan / Bendahara / Cair / SPJ</th>
                                        <th>Nominal</th>
                                        <th>#</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= rupiah($kfe) ?></td>
                                            <td><a href="<?= base_url('lembaga/historyDtl/' . $a->kode_pengajuan) ?>"><button class="btn btn-primary btn-sm"><i class="bx bx-search"></i>Lihat
                                                        Detail</button></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
