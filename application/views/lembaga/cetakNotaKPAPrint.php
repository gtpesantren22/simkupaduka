...
<body>
    <div class="invoice-box">
        ...
        <div class="no-print-bar no-print">
            <h5>Pratinjau Cetak Nota KPA</h5>
        ...
        <!-- Meta Info Cards (Submissions Details) -->
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-end fw-bold"><?= rupiah($total_item) ?></td>
                    </tr>
                <?php endforeach; ?>
                ...
                <tr class="total-row">
                    ...
                    <td colspan="2" class="text-end total-val"><?= rupiah($grand_total) ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="invoice-footer">
            <div class="footer-note">
                <p>* Nota KPA ini berfungsi sebagai rekapitulasi bukti sah pengambilan barang kepada Mitra Pesantren untuk pengajuan pencairan non-tunai.</p>
            </div>
