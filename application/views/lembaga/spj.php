                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            | <button class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#stt<?= $ls_jns->id_spj; ?>"><i
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= 'file_spj/' . $ls_jns->file_spj ?>"><i
                                                    class="bx bx-download"></i> <?= $ls_jns->file_spj ?></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <!-- Modal -->
                                    <div class="modal fade" id="stt<?= $ls_jns->id_spj; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <form action="<?= base_url('lembaga/uploadSpj'); ?>" method="post" class=""
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="file" class="form-control" name="f_rin"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <br><br>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-success"><i
                                                                class="bx bx-save"></i> Simpan berkas</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
