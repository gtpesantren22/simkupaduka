                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Pengajuan dibuat oleh KPA <?= $lembaga->nama; ?></h5>
                                            <small class="text-muted"><span class="badge bg-primary">Pengajuan
                                                    Dibuat</span></small>
                                        </div>
                                        <p class="mb-1">Tanggal Pengajuan</p> <small class="text-muted"> Pada :
                                            <?= $data->at; ?></small>
                                    </a>
                                    <?php foreach ($veral as $vv) { ?>
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Diverifikasi oleh <?= $vv->user; ?></h5>
                                            <small class="text-muted"><span
                                                    class="badge bg-success">Diverifikasi</span></small>
                                        </div>
                                        <p class="mb-1">Waktu Verifikasi</p> <small class="text-muted">Pada :
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Waktu Pencairan <?= $app->user; ?></h5>
                                            <small class="text-muted"><span
                                                    class="badge bg-warning">Disetujui</span></small>
                                        </div>
                                        <p class="mb-1">Waktu Persetujuan</p> <small class="text-muted">Pada :
                                            <span><?= $vv->tgl_verval; ?></small>
                                    </a>
                                    <?php }
                                    foreach ($cair as $acc) { ?>
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Dicairkan oleh <?= $acc->kasir; ?></h5>
                                            <small class="text-muted"><span
                                                    class="badge bg-danger">Dacairkan</span></small>
                                        </div>
                                        <p class="mb-1">Waktu Pencairan</p> <small class="text-muted">Pada :
                                            <span><?= $acc->tgl_cair; ?></span><br>
                                            Nominal : <span><?= rupiah($acc->nominal_cair); ?></span></small>
                                    </a>
                                    <?php } ?>
                                </div>
