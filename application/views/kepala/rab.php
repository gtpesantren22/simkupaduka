                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <ul class="list-group">
                                    <?php foreach ($data as $a) : ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <?= $a->kode . '. ' . $a->nama; ?>
                                            <a href="<?= base_url('kepala/rabDetail/') . $a->kode ?>" class="btn btn-primary btn-sm"><i class="bx bx-detail"></i> Lihat
                                                Detail</a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            ...
                            <div class="col-md-4">
                                ...
                                <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bx bx-cloud-upload"></i> Upload
                                    RAB</button><br>
                            </div>
...
<!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open_multipart('kepala/uploadRab'); ?>
            <div class="modal-body">
                ...
                <a href="<?= base_url('kepala/downRabTmp'); ?>"><i class="bx bx-download"></i> Donload Template Format
                    Upload RAB Disini!</a>
            </div>
