        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="card radius-10">
                    <div class="card-body">
                        <form action="<?= base_url('account/updateAkun') ?>" method="post">
            ...
            <div class="col-12 col-md-6">
                <div class="card radius-10">
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="<?= base_url('account/updateLembaga') ?>">
                            <div class="box-body">
                                <div class="form-group mb-2">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open_multipart('account/uploadFoto') ?>
