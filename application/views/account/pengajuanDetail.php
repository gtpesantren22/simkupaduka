                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <address>
                                    ...
                                    <a href="<?= base_url('account/vervalPengajuan/' . $rinci->kode_pengajuan); ?>"
                                        class="btn btn-success btn-sm tbl-confirm"
                                        value="Pengajuan akan disetujui dan selanjutnya akan dicairkan"><i
                                            class="bx bx-check-circle"></i>Verifikasi/Setujui</a><br>
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#ex_tolak"><i class="bx bx-no-entry"></i>Tolak
                                        pengajuan</button><br>
                                    <?php } ?>
                                </address>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                                ...
                                                ?>
                                            <?php if ($htgd > 0) { ?>
                                            <b><i><a href="<?= base_url('account/downHonor/' . $fl->files); ?>"> (<i
                                                            class="bx bx-download"></i> Download)</a></i></b>
                                            <?php } else { ?>
                                        ...
                                        <td>
                                            <?php if ($rinci->cair == 0) { ?>
                                            <a href="<?= base_url('account/delRealSm/' . $a->id_realis) ?>"
                                                class="tombol-hapus"><span class="bx bx-no-entry text-danger">
                                                </span></a>
                                            |
                                            <a type="button" data-bs-toggle="modal"
                                                data-bs-target="#bs-example<?= $a->id_realis ?>"><span
                                                    class="bx bx-pencil text-success"> </span></a>

                                            <div class="modal fade" id="bs-example<?= $a->id_realis ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?= base_url('account/editRealSm'); ?>"
                                                            method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group mb-2 mb-2">
                                                                    ...
                                                                    <input type="text" name="nom_cair"
                                                                        value="<?= $a->nom_cair; ?>"
                                                                        class="form-control uang" required>
                                                                </div>
            ...
            <form action="<?= base_url('account/tolakPengajuan'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="">
                            <input type="text" id="" name="lembaga" required="required" value="<?= $lembaga->nama ?>"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="">
                            <input type="text" id="" name="user" required="required" value="<?= $user->nama ?>"
                                class="form-control" readonly>
                        </div>
                    </div>
                </div>
