            ...
            <div class="col-12 col-lg-12">
                <div class="card radius-10">
                    <div class="card-body">
                        ...
                        <?= form_open('account/saveEditPes'); ?>
                        <input type="hidden" name="id_pes" value="<?= $pes->id_pes ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="bidang" class="form-control" id="" required>
                                    ...
                                    <?php
                                    foreach ($bidang as $a) { ?>
                                        <option <?= $a->kode == $pes->bidang ? 'selected' : '' ?> value="<?= $a->kode ?>">
                                            <?= $a->kode ?>.
                                            <?= $a->nama ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="tgl_bayar" id="date" class="form-control" required value="<?= $pes->tgl_bayar; ?>">
                            </div>
                        </div>
