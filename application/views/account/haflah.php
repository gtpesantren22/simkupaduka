                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <h4 class="my-1 text-info"><?= rupiah($pagu->jml) ?></h4>
                                                <p class="mb-0 font-13">Jumlah pagu untuk haflah</p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <h4 class="my-1 text-success"><?= rupiah($pagu->jml - $pakai->jml) ?></h4>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('account/haflahDetail/' . $ls_jns->kode_pengajuan) ?>"><button class="btn btn-info btn-sm"><i class="bx bx-search"></i>
                                                        cek</button></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
