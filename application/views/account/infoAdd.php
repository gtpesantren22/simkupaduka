...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Tambah Data Informasi</div>
            <div class="ps-3">
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="mb-0 text-uppercase">Form Tambah Data Informasi</h6>
                        <hr>
                        <form method="post" action="<?= base_url('account/saveInfo'); ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="date" name="tgl"
                                        placeholder="Tanggal Informasi" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="mytextarea" name="isi" required>Hello, World!</textarea>
                                </div>
                            </div>
