...
Terimakasih';
	...
	function haflahDetail($kode)
	{
		...
		$data['data'] = $this->db->query("SELECT haflah_detail.*, haflah_bidang.nama, haflah_bidang.kode_bidang FROM haflah_detail JOIN haflah_bidang ON haflah_detail.bidang=haflah_bidang.kode_bidang WHERE kode_pengajuan = '$kode' AND haflah_bidang.tahun = '$this->tahun' AND haflah_detail.tahun = '$this->tahun' ORDER BY bidang ASC ")->result();
