                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select name="nis" id="" class="form-control cari1">
                                            ...
                                            <?php
                                            $santri = mysqli_query($conn, "SELECT a.*, b.nis FROM tb_santri a JOIN tanggungan b ON a.nis=b.nis WHERE a.aktif = 'Y' ");
                                    ...
                                    <div class="col-md-2">
                                        <button name="cek" type="submit" class="btn btn-success"><span class="fa fa-search"> </span>
                                            Cari Santri</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="small-box bg-red">
                                        <div class="inner">
                                            <h3><?= rupiah($ttl['jml'] - $masuk['jml']); ?></h3>
                                            <p>Kekurangan</p>
                                        </div>
                                        <div class="icon">
                                    ...
                                    <div class="box box-danger">
                                        ...
                                        <div class="box-body">
                                            <form role="form" action="" method="POST">
                                                ...
                                                <input type="hidden" name="ttl" value="<?= $ttl['jml']; ?>">
