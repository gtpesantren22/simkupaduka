                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="example1_bst" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $rls = mysqli_query($conn, "SELECT a.*, b.nama FROM pengajuan a JOIN lembaga b ON a.lembaga=b.kode WHERE a.verval = 1 AND a.apr = 1 AND a.kode_pengajuan NOT LIKE '%DISP.%' AND a.tahun = '$tahun_ajaran' GROUP BY a.kode_pengajuan ");
