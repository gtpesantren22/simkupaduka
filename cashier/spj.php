                                            ...
                                            <td>
                                                <?php if ($ls_jns['stts'] == 0) { ?>
                                                    ...
                                                    <?php if ($ls_jns['b_cair'] == 1) { ?>
                                                        | <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#staticBackdrop"><i class="fa fa-upload"></i> Upload berkas SPJ</button>
                                                    <?php } ?>
                                                <?php } else if ($ls_jns['stts'] == 1) { ?>
                                                    ...
                                                    <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#staticBackdrop"><i class="fa fa-upload"></i> Upload ulang berkas SPJ</button>
                                                <?php } else { ?>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="kode" class="form-control" value="<?= $ls_jns['kode']; ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="form-group">
